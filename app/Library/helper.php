<?php 
	...
	function sendphone($p){
		...
		$options['accountsid']='47d2946d1be1ff77ed3ae19de1ae1946';
		//填写在开发者控制台首页上的Auth Token
		$options['token']='8449cb165b4849bb274955d6872b8ab9';

		//初始化 $options必填
		$ucpass = new Ucpaas($options);
		$appid = "bba6488ea9de469996c56aaf7359f687";	//应用的ID，可在开发者控制台内的短信产品下查看
		$templateid = "480943";    //可在后台短信产品→选择接入的应用→短信模板-模板ID，查看该模板ID
		//发送的校验码
